...
// CardInfoMessage represents the incoming SQS message structure
type CardInfoMessage struct {
...
// IsValid validates the CardInfoMessage
func (c *CardInfoMessage) IsValid() bool {
