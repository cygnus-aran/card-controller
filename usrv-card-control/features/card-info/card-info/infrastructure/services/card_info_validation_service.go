...
func (s *CardInfoValidationService) ValidateCardInfoMessage(message *entities.CardInfoMessage) error {
...
func (s *CardInfoValidationService) validateRequiredFields(message *entities.CardInfoMessage) error {
...
func (s *CardInfoValidationService) validateBusinessRules(message *entities.CardInfoMessage) error {
